<h1 align="center"> Page Security</h1>
...
O projeto "Rocket.sect" é um site que aborda a temática de segurança da informação. O objetivo é apresentar uma empresa fictícia especializada em proteção de dados e conscientizar os usuários sobre a importância da segurança da informação nas empresas.

🔗 O projeto pode ser acessado através do [GitHub](https://github.com/f18Marcelo/Recriando-Layout.git)
